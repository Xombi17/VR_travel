...
const imagesDir = path.join(process.cwd(), 'public', 'images', 'videos');
...
async function downloadAllImages() {
  try {
    ...
    console.log('All video thumbnails downloaded successfully!');
  } catch (error) {
